 ...
 */
// C# TO JAVA CONVERTER TODO TASK: The C# 'new()' constraint has no equivalent
// in Java:
// ORIGINAL LINE: public class TRF2ItemGroup<T> : RF2Item where T :
// RF2ItemSingle, new()
public class TRF2ItemGroup<T extends RF2ItemSingle> extends RF2Item {
	...
	public final T getCurrent() {
		...
		while (index >= 0) {
			...
			if (item.EffectiveTime.compareTo(DateTime.now()) <= 0) {
				return item;
			}
			index -= 1;
		}
